...
logger.add("training.log", level="INFO", rotation="100 MB")
...
def main():
    ...
    #region Log on each process the small summary:
    logger.warning(
    ...
    #TODO: use my dataset and dataset_loader
    if data_args.dataset_name is not None:
        ...
        # load the dataset from load dictory
        data_files = {}
        dataset_args = {}
    ...
    if 'llama' in model_args.model_name_or_path.lower():
        ...
        model = LlamaForCausalLM.from_pretrained(model_args.model_name_or_path,
                                    ...
                                    token=model_args.token,
                                    trust_remote_code=model_args.trust_remote_code,
                                    torch_dtype=model_args.torch_dtype if model_args.torch_dtype is not none else torch.float16,
